...
const Footer = () => {
    return (
        ...
        <footer class="bg-gradient-to-r from-cyan-500 to-blue-500  pt-20 text-center text-white ">
              ...
              <form action="">
                <div
                  ...
                  <div class="relative md:mb-6" data-te-input-wrapper-init>
                    <input
                      type="text"
                      class="peer block min-h-[auto] w-full rounded-xl border-0 bg-sky-900 px-3 py-[0.32rem] leading-[1.6] text-neutral-200 outline-none transition-all duration-200 ease-linear focus:placeholder:opacity-100 data-[te-input-state-active]:placeholder:opacity-100 motion-reduce:transition-none dark:text-neutral-200 dark:placeholder:text-neutral-200 [&:not([data-te-input-placeholder-active])]:placeholder:opacity-0"
          ...
          <div
            ...
            >
            © 2023 Copyright:
            <a class="text-white" href="https://github.com/Reshad402?tab=stars"
              > AFIRES</a
            >
          </div>
        </footer>
